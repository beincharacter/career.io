  ...
  return (
    <div className="bg-white">
      <div className="flex gap-5 max-md:flex-col max-md:gap-0">
        <aside className="flex flex-col w-[19%] max-md:ml-0 max-md:w-full h-screen border">
          <nav className="flex flex-col h-full justify-between self-stretch py-8 mx-auto w-full shadow-sm bg-slate-50 leading-[160%] overflow-y-auto">
            <div>
              <div className="flex gap-2 mx-6 text-2xl font-bold tracking-tight leading-9 text-gray-800 whitespace-nowrap max-md:mx-2.5 mb-8">
            ...
            <div className="flex flex-col justify-center px-8 pt-5 max-md:px-5">
