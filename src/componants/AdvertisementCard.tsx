...
export const AdvertisementCard: React.FC = () => (
    <section className="flex justify-center w-full pt-20">
        ...
        <section className="flex overflow-hidden relative text-white flex-col items-start px-20 mx-0 sm:mx-20 py-20 w-full fill-indigo-600 max-w-[1350px] max-md:px-5 max-md:max-w-full">
